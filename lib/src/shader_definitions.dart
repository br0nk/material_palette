...
final grittyGradientDef = ShaderDefinition(
  layout: UniformLayout([
    ...
    ...ParamGroups.commonNoiseFields,
    ...ParamGroups.colorsFields,
  ...
  defaults: ShaderParams(
    values: {
      ...
      'animSpeed': 0.0,
      'midPosition': -1.0, 'exposure': 1.0, 'contrast': 1.0,
    },
    colors: {
      'colorA': const Color.fromRGBO(235, 200, 216, 1),
      'colorB': const Color.fromRGBO(115, 140, 191, 1),
      'colorMid': const Color.fromRGBO(179, 166, 204, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.linearGradientRanges,
    ...ParamGroups.grittyNoiseRanges,
    ...ParamGroups.colorsRanges,
...
final radialGrittyGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'animSpeed': 0.0,
      'midPosition': 0.50, 'exposure': 1.0, 'contrast': 1.0,
    },
    colors: {
      'colorA': const Color.fromRGBO(255, 230, 180, 1),
      'colorB': const Color.fromRGBO(100, 80, 140, 1),
      'colorMid': const Color.fromRGBO(230, 140, 120, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
...
final perlinGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 48.55, 'noiseIntensity': 0.46, 'ditherStrength': 0.0,
      'animSpeed': 0.91,
      'noiseScale': 2.60, 'noiseContrast': 3.00,
      'midPosition': 0.24, 'exposure': 1.0, 'contrast': 1.00,
      'bumpStrength': 0.0,
    ...
    colors: {
      'colorA': const Color.fromRGBO(37, 146, 244, 1),
      'colorB': const Color.fromRGBO(20, 24, 133, 1),
      'colorMid': const Color.fromRGBO(242, 252, 252, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.linearGradientRanges,
    ...ParamGroups.commonNoiseRanges,
    'noiseScale': const SliderRange('Noise Scale', min: 1.0, max: 10.0),
...
final radialPerlinGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 53.92, 'noiseIntensity': 0.57, 'ditherStrength': 0.0,
      'animSpeed': 0.86,
      'noiseScale': 4.45, 'noiseContrast': 0.66,
      'midPosition': 0.50, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 1.05,
    ...
    colors: {
      'colorA': const Color.fromRGBO(200, 230, 201, 1),
      'colorB': const Color.fromRGBO(27, 94, 32, 1),
      'colorMid': const Color.fromRGBO(76, 175, 80, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.radialGradientRanges,
...
final simplexGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 40.0, 'noiseIntensity': 0.32, 'ditherStrength': 0.25,
      'animSpeed': 0.35,
      'noiseScale': 2.0, 'sharpness': 2.20,
      'midPosition': 0.45, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 0.45,
    ...
    colors: {
      'colorA': const Color.fromRGBO(103, 58, 183, 1),
      'colorB': const Color.fromRGBO(49, 27, 146, 1),
      'colorMid': const Color.fromRGBO(179, 136, 255, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.linearGradientRanges,
...
final radialSimplexGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 29.94, 'noiseIntensity': 0.36, 'ditherStrength': 0.0,
      'animSpeed': 0.35,
      'noiseScale': 6.42, 'sharpness': 1.27,
      'midPosition': 0.56, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 0.33,
    ...
    colors: {
      'colorA': const Color.fromRGBO(246, 187, 77, 1),
      'colorB': const Color.fromRGBO(23, 45, 144, 1),
      'colorMid': const Color.fromRGBO(211, 211, 211, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.radialGradientRanges,
...
final fbmGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 22.57, 'noiseIntensity': 0.88, 'ditherStrength': 0.0,
      'animSpeed': 0.33,
      'octaves': 5.0, 'lacunarity': 2.10, 'persistence': 0.50, 'noiseScale': 2.0,
      'midPosition': 0.51, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 0.10,
    ...
    colors: {
      'colorA': const Color.fromRGBO(141, 110, 99, 1),
      'colorB': const Color.fromRGBO(62, 39, 35, 1),
      'colorMid': const Color.fromRGBO(188, 170, 164, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.linearGradientRanges,
...
final radialFbmGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 15.83, 'noiseIntensity': 0.38, 'ditherStrength': 0.0,
      'animSpeed': 0.30,
      'octaves': 6.12, 'lacunarity': 1.93, 'persistence': 0.53, 'noiseScale': 4.07,
      'midPosition': 0.13, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 0.52,
      'lightDirX': 0.50, 'lightDirY': 0.50, 'lightDirZ': 1.0,
    ...
    colors: {
      'colorA': const Color.fromRGBO(215, 216, 226, 1),
      'colorB': const Color.fromRGBO(62, 39, 35, 1),
      'colorMid': const Color.fromRGBO(161, 136, 127, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.radialGradientRanges,
...
final turbulenceGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 25.0, 'noiseIntensity': 0.51, 'ditherStrength': 0.0,
      'animSpeed': 0.50,
      'octaves': 2.00, 'baseFrequency': 0.81, 'noiseScale': 1.16,
      'midPosition': 0.40, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 0.77,
    ...
    colors: {
      'colorA': const Color.fromRGBO(255, 138, 101, 1),
      'colorB': const Color.fromRGBO(183, 28, 28, 1),
      'colorMid': const Color.fromRGBO(255, 87, 34, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.linearGradientRanges,
    ...
    'noiseScale': const SliderRange('Noise Scale', min: 0.5, max: 5.0),
    ...ParamGroups.edgeFadeRanges,
    ...ParamGroups.colorsRanges,
    ...ParamGroups.postProcessingRanges,
    ...ParamGroups.lightingRanges,
...
final radialTurbulenceGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 24.94, 'noiseIntensity': 0.51, 'ditherStrength': 0.0,
      'animSpeed': 0.75,
      'octaves': 3.02, 'baseFrequency': 1.94, 'noiseScale': 1.57,
      'midPosition': 0.34, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 1.68,
    ...
    colors: {
      'colorA': const Color.fromRGBO(75, 65, 216, 1),
      'colorB': const Color.fromRGBO(82, 36, 117, 1),
      'colorMid': const Color.fromRGBO(162, 187, 221, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.radialGradientRanges,
...
final voronoiGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 44.19, 'noiseIntensity': 0.12, 'ditherStrength': 0.02,
      'animSpeed': 1.27,
      'cellScale': 4.59, 'cellJitter': 1.0, 'distanceType': 0.45,
    ...
    colors: {
      'colorA': const Color.fromRGBO(251, 255, 220, 1),
      'colorB': const Color.fromRGBO(0, 83, 87, 1),
      'colorMid': const Color.fromRGBO(77, 225, 203, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.linearGradientRanges,
    ...ParamGroups.commonNoiseRanges,
    'cellScale': const SliderRange('Cell Scale', min: 1.0, max: 15.0),
...
final radialVoronoiGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 40.0, 'noiseIntensity': 0.26, 'ditherStrength': 0.0,
      'animSpeed': 0.65,
      'cellScale': 3.71, 'cellJitter': 0.07, 'distanceType': 0.0,
      'outputMode': 0.0, 'cellSmoothness': 0.50,
      'midPosition': 0.28, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 0.68,
    ...
    colors: {
      'colorA': const Color.fromRGBO(255, 208, 39, 1),
      'colorB': const Color.fromRGBO(0, 77, 64, 1),
      'colorMid': const Color.fromRGBO(0, 150, 136, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.radialGradientRanges,
...
final voronoiseGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 67.46, 'noiseIntensity': 0.55, 'ditherStrength': 0.0,
      'animSpeed': 0.00,
      'cellScale': 5.60, 'noiseBlend': 0.38, 'edgeSmoothness': 0.11,
      'midPosition': -0.06, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 0.0,
    ...
    colors: {
      'colorA': const Color.fromRGBO(244, 221, 37, 1),
      'colorB': const Color.fromRGBO(44, 8, 71, 1),
      'colorMid': const Color.fromRGBO(247, 255, 212, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.linearGradientRanges,
...
final radialVoronoiseGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseDensity': 83.89, 'noiseIntensity': 0.34, 'ditherStrength': 0.0,
      'animSpeed': 0.0,
      'cellScale': 1.74, 'noiseBlend': 0.07, 'edgeSmoothness': 0.29,
      'midPosition': 0.54, 'exposure': 1.0, 'contrast': 1.0,
      'bumpStrength': 1.19,
    ...
    colors: {
      'colorA': const Color.fromRGBO(63, 95, 218, 1),
      'colorB': const Color.fromRGBO(59, 35, 118, 1),
      'colorMid': const Color.fromRGBO(161, 204, 221, 1),
    },
  ),
  uiDefaults: ShaderUIDefaults({
    ...ParamGroups.radialGradientRanges,
