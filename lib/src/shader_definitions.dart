...
final simplexGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseIntensity': 0.32, 'ditherStrength': 0.0, 'ditherScale': 1.0,
      'animSpeed': 0.35,
...
final fbmGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseIntensity': 0.88, 'ditherStrength': 0.0, 'ditherScale': 1.0,
      'animSpeed': 0.33,
...
final radialVoronoiGradientDef = ShaderDefinition(
  ...
  defaults: ShaderParams(
    values: {
      ...
      'noiseIntensity': 0.26, 'ditherStrength': 0.0, 'ditherScale': 1.0,
      'animSpeed': 0.5,
